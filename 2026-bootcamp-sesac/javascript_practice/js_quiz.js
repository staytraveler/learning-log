...
const inputPrice = '12000';
const inputDeliveryFee = '3000';
const priceA = Number(inputPrice);
const delivaeryFee = Number(inputDeliveryFee);
const sum = priceA + delivaeryFee;
console.log('총 결제 금액:', sum);
console.log('현재 타입:', typeof (sum));
